...
public class ImagePreviewActivity extends BaseUiActivity implements View.OnClickListener {
    ...
    public static void startActivity(Context mContext, boolean isUrl, String url) {
        ...
        intent.putExtra(Contants.INTENT_IMAGE_TYPE, isUrl);
        intent.putExtra(Contants.INTENT_IMAGE_URL, url);
    ...
    private void initView() {
        ...
        boolean isUrl = intent.getBooleanExtra(Contants.INTENT_IMAGE_TYPE,false);
        url = intent.getStringExtra(Contants.INTENT_IMAGE_URL);
            ...
            case R.id.tv_download:
                GlideHelper.loadUrlToBitmap(this, url, new GlideHelper.OnGlideBitmapResultListener() {
                    ...
                    public void onResourceReady(Bitmap resource) {
                        if(resource != null){
                            FileMessage.getInstance().saveBitmapToAlbum(ImagePreviewActivity.this,resource);
                        }else{
                        }
                    }
                });
